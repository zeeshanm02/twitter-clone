    ...
    <>
      ...
      >
        <div className="w-full h-full relative  rounded-lg bg-black border border-gray-500 sm:w-[600px] sm:h-[386px] text-white  sm:p-10 p-4">
            <div className="absolute w-[2px] h-[77px] bg-gray-500  top-[96px] left-[40px] sm:left-[64px] sm:top-[120px]"></div>
            <div
            onClick={() => dispatch(closeCommentModal())} className="absolute top-4 cursor-pointer">
                <XIcon className="w-6"/>
            </div>
          <div className="mt-8">
            <div className="flex space-x-3 w-full">
              ...
              <div className="">
                <div className="flex space-x-1.5">
                  ...
                  <h1 className="text-gray">@{tweetDetails.username}</h1>
                </div>
            ...
            <div className="flex space-x-3 ">
                ...
                <textarea
                    ...
                    className="w-full text-lg bg-transparent resize-none"
